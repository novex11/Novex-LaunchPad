...
export function MarketList({ stocks, byTicker, loading, watchlist, onClear }: MarketListProps) {
  ...
  return (
    <>
      ...
      <div className="hidden grid-cols-[2.5rem_1fr_7rem_8rem_6rem_9rem] items-center gap-4 border-b border-border-subtle px-5 py-2.5 md:grid">
        <span />
        ...
        {stocks.map((s, i) => {
          ...
          return (
            <motion.li
              ...
              className="group relative grid grid-cols-[2rem_1fr_auto] items-center gap-3 px-4 py-3 transition-colors hover:bg-accent-subtle/40 md:grid-cols-[2.5rem_1fr_7rem_8rem_6rem_9rem] md:gap-4 md:px-5"
            >
              <button
                type="button"
              ...
              <Link href={`/markets/${s.ticker}`} className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold leading-tight">
                    {s.ticker}
                    <span className="ml-2 hidden font-mono text-[10px] font-normal uppercase text-muted-foreground lg:inline">
                      {s.exchange}
                    </span>
                  </p>
              ...
              <div className="col-span-3 flex justify-end gap-1.5 md:col-span-1">
                <button
                  type="button"
